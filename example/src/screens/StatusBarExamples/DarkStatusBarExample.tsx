/**
 * DarkStatusBarExample
 *
 * This screen demonstrates the `StatusBar` component with the **dark variant** applied.
 *
 * Demonstrates:
 * - Rendering the `StatusBar` using `variant="dark"` for dark content styling.
 ...
 *   **dark mode / dark-themed UIs** using the `variant` prop.
 *
...
export function DarkStatusBarExample() {
